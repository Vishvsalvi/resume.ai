...
import { AlertCircle, Bell, CreditCard, Key, Lock, Save, User, Users, CheckCircle, X } from "lucide-react"
                  ...
                  {saveStatus && (
                    <div className={`p-4 rounded-md ${saveStatus === "success" ? "bg-green-50" : "bg-red-50"}`}>
                      <div className="flex">
                        ...
                        <div className="ml-3">
                          <p
                            className={`text-sm font-medium ${saveStatus === "success" ? "text-green-800" : "text-red-800"}`}
                          >
                            {saveStatus === "success"
                ...
                <div className="mt-6 pt-6 border-t">
                  <div className="flex items-center justify-between">
                    <div className="space-y-1">
                      ...
                      <p className="text-sm text-gray-500">
                        Generate recovery codes to access your account if you lose your two-factor authentication
                        device.
                      </p>
                    </div>
                  ...
                  <div className="p-4 bg-blue-50 rounded-lg border border-blue-100">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-sm text-gray-600">$99/month • Renews on April 1, 2023</p>
                      </div>
                      <Badge className="bg-blue-100 text-blue-800 hover:bg-blue-200">Current Plan</Badge>
                    </div>
                    <div className="mt-4 pt-4 border-t border-blue-100">
                      <p className="text-sm text-gray-600">
                        Your plan includes up to 200 resumes per month, 5 team members, and advanced AI screening
                        features.
                      </p>
                    </div>
                  </div>
                ...
                <div className="space-y-6">
                    ...
                    <div className="space-y-4">
                      <div className="flex items-center justify-between">
                        <div className="space-y-0.5">
                          ...
                          <p className="text-sm text-gray-500">Receive an email when a screening is completed</p>
                        </div>
                      ...
                      <div className="flex items-center justify-between">
                        <div className="space-y-0.5">
                          <p className="font-medium">New Candidate Shortlisted</p>
                          <p className="text-sm text-gray-500">
                            Receive an email when a team member shortlists a candidate
                          </p>
                        </div>
                        <Switch defaultChecked />
                      </div>
                      ...
                      <div className="flex items-center justify-between">
                        <div className="space-y-0.5">
                          ...
                          <p className="text-sm text-gray-500">Receive a weekly summary of your screening activity</p>
                        </div>
                        <Switch />
                      </div>
                    </div>
                  ...
                  <div className="pt-6 border-t">
                    ...
                    <div className="space-y-4">
                      <div className="flex items-center justify-between">
                        <div className="space-y-0.5">
                          <p className="font-medium">Screening Updates</p>
                          <p className="text-sm text-gray-500">Receive notifications for screening status changes</p>
                        </div>
                        <Switch defaultChecked />
                      </div>
                      ...
                      <div className="flex items-center justify-between">
                        <div className="space-y-0.5">
                          ...
                          <p className="text-sm text-gray-500">Receive notifications for team member actions</p>
                        </div>
                        <Switch defaultChecked />
                      </div>
